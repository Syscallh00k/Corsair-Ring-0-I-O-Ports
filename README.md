...
# How To Use
Download the repository, compile the project and place everything from the libs folder to were the compiled executable is. You can also grab the fresh files from its normal location.
`C:\Program Files\Corsair\Corsair Device Control Service\bin`

# Output Example
<img width="1021" height="600" alt="image" src="https://github.com/Syscallh00k/Corsair-Ring-0-I-O-Ports/blob/main/corsair.png" />
